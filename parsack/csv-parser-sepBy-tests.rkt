...
(define line (>>= cells (λ (result) (>>= eol (λ _ (return result))))))
(define remainingCells (<or> (>>= (char #\,) (λ _ cells))
                             (return null)))

;; tests for csv-parser-sepBy.rkt
;; (this file is entirely duplicated from csv-parser-tests.rkt,
